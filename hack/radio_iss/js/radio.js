...
class RadioManager {
  ...
  init() {
    ...
    // Do NOT force crossOrigin on streams; some stations reject CORS and break playback
  ...
  setupEventListeners() {
    ...
    if (this.radioPlayer) {
      // WebAudio analysis disabled due to CORS restrictions on most radio streams
      // Once MediaElementSource is created, it permanently hijacks audio element output
      // Most internet radio streams don't provide CORS headers, causing silent playback
